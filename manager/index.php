...
<body style="background-color: rgb(218,218,218);">
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-white portfolio-navbar">
        <div class="container"><a class="navbar-brand logo" href="index.php"><img src="../assets/img/tf.png" style="width: 25%;height: 20%;"></a>
        <button data-toggle="collapse" class="navbar-toggler" data-target="#navbarNav"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon" style="color: rgb(255,255,255);background-color: #ff00e2;"></span></button>
            <div
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped myTable">
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="edit_record.php?id='.$data['list_id'].'" class="btn border rounded" style="background-color: #008CBA; color: white"><i class="fa fa-edit"></i> Edit</a>
                                </td>
                            </tr>';
