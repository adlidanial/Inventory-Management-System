                ...
                <div style="background-color: #ffffff;">
                    <div class="table-responsive">
                        <table class="table table-striped order-table">
                            ...
                            $sql = mysqli_query($connect, "SELECT * FROM user") or die(mysqli_error($connect));
                            ...
                            if(mysqli_num_rows($sql) > 0){
                                ...
                                while($data = mysqli_fetch_assoc($sql)){
                                    ...
                                    <tr>
                                        ...
                                        <td>'.$data['role'].'</td>
                                        <td>
                                            <a href="edit_user.php?id='.$data['user_id'].'" class="btn border rounded" style="color: white;background-color: #008CBA"><i class="fa fa-edit"></i> Edit</a>
                                        </td>
