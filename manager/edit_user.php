...
if(isset($_POST['submit']))
{
    ...
    mysqli_stmt_bind_param($result, 'sissi', $name, $phoneno, $email, $role, $userid);
    $result = mysqli_stmt_execute($result);
    
    if($result)
    {
        echo ("<script>
        window.alert('Succesfully update user.');
            ...
            <div
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle active" style="color: rgb(0,0,0);" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Maintenance
                        </a>
    ...
    <main class="page lanidng-page">
        <section class="portfolio-block block-intro">
            <div class="container">
                ...
                <hr>
                <div>
                    <form style="background-color: #ffffff;" method="post" action="edit_user.php">
                    <?php
                        $id = $_GET['id'];
                        //query to database SELECT table based on bigger id
                        $sql = mysqli_query($connect, "SELECT * FROM user
                        WHERE user_id = $id") or die(mysqli_error($connect));
                    ...
                    ?>
                        ...
                        <div class="form-group text-left">
                            ...
                            <input class="form-control" type="text" name="phoneno" value="<?php echo $data['nophone']; ?>" required>
                        </div>
                        <div class="form-group text-left">
                        ...
                        <a href="user.php"><button class="btn btn-secondary border rounded float-left" type="button">Back</button></a>
                    </form>
                </div>
            </div>
        </section>
